...
--
-- Host: 127.0.0.1
-- Creato il: Mag 23, 2021 alle 19:29
...
--
-- Database: `hmw` 
-- SE NON PRESENTE USARE -> CREATE DATABASE hmw;
...
('a@gmail.com', 'MGZjNTY4YWIwZTEwYjBiN2MyYzAwMDI1ODNmMmE3Mjc1Yzc4NDhiMjA2MWRlOTg1N2RmODYwOTJiM2E3OTUyZQ==', 'Carlo', 'Pio', 'egsg,wegqeg,24', 'enaoeo'),
...
('Mich@gmail.com', 'ZWQzN2ZlNDhjNTA1ZWExMDdmZDFmOTMwZDNhMDQ3NWIyNjRmMWIzODg2NDI0NmQ0YWY5OWJlNGEwMTM3YTM1Ng==', 'Michele', 'Maurici', 'Catania,Via Etnea,12', 'Italia');
...
ALTER TABLE `copia_pvt`
  ADD PRIMARY KEY (`Numero`,`Id_transazione`,`Software`),
...
--
ALTER TABLE `copia_pvt`
  ADD CONSTRAINT `copia_pvt_ibfk_1` FOREIGN KEY (`Id_transazione`) REFERENCES `transazione` (`Id`),
...
--
ALTER TABLE `report_p`
  ADD CONSTRAINT `report_p_ibfk_1` FOREIGN KEY (`Cliente`) REFERENCES `cliente_privato` (`Email`),
